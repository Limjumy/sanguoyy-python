...
with codecs.open("2 sanguoyy.txt", "r", "utf-8") as f:
    for line in f.readlines():
        ...
        for w in poss:
            ...
            if w.flag != "na" and w.flag != "pl" and w.flag != "v" and w.flag != "a":  # 当该词语不是人名或者地名时
                continue
...
with codecs.open("2 roles and places and v and adj.txt", "a+", "utf-8") as f:
