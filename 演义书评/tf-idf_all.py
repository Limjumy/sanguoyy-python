...
# 遍历书评的时候，根据书评的文件名排序遍历的，不是根据文件夹中已经摆放好的顺序
# 使用sklearn中的函数包tf-idf
# 遍历每条书评，分词
# 统计每篇评论的词语tf-idf
# 统计每条评论的关键词
