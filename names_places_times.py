...
##打印names看一看
#with codecs.open("2 names_places_times_sanguoyy.txt", "a+", "utf-8") as f:
...
# output
with codecs.open("2 names_places_relationships_sanguoyy.txt", "a+", "utf-8") as f:
